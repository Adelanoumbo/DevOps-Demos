...
useradd jenkins-agent-01
# Create SSH Keys
sudo su - jenkins-agent-01
ssh-keygen -t rsa -N "" -f /home/jenkins-agent-01/.ssh/id_rsa
# The private and public keys will be created at these locations `/home/jenkins-agent-01/.ssh/id_rsa` and `/home/jenkins-agent-01/.ssh/id_rsa.pub`
cd .ssh
